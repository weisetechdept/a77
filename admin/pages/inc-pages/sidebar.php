    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect"><i class="fas fa-address-book"></i><span>การตรวจสอบ</span></a>
                    ...
                    <li><a href="/admin/randchk-agent" class="waves-effect"><i class="feather-clipboard"></i><span>เช็คสมาชิกอนุมัติ</span></a></li>
                </li>
                <!--
