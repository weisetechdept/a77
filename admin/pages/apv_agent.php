                        ...
                        <div class="col-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-2">เลือกสถานะการตรวจสอบผู้แนะนำ</p>
                                    <div class="mb-3">
                                        <div class="form-group">
                                            <select class="form-control" v-model="action">
                                                <option value="0">= เลือกสถานะ =</option>
                                                <option value="2">ผ่านการตรวจสอบ</option>
                                                <option value="10">ไม่ผ่านการตรวจสอบ</option>
                                            </select>
                                        </div>
                                        <button class="btn btn-primary waves-effect waves-light" @click="sendData()">บันทึก</button>
                                    </div>
    ...
    <script>
        var chk_agent = new Vue({
            ...
            mounted() {
                ...
                axios.get('/admin/system/apv_agent.api.php').then(response => {
